                ...
                <div class="d-flex flex-column gap-2 justify-content-center">
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <a href="https://www.youtube.com/watch?v=hz2zCdgvRzA&t=2s&ab_channel=DTunnel" class="card-link d-flex justify-content-center">Alterar as credenciais</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <a class="btn btn-dark w-100 mt-2">BAIXAR</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body p-2">
                    ...
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            <p class="card-text">
                                Esta versão contém apenas modos de conexão SSH, OpenVPN e V2RAY
                            </p>
                            <a class="btn btn-dark w-100 mt-2">BAIXAR</a>
                        </div>
                    </div>
